...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FindingNemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11FindingNemo11AppDelegate")
...
SWIFT_CLASS("_TtC11FindingNemo15LocationManager")
...
@interface LocationManager (SWIFT_EXTENSION(FindingNemo)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC11FindingNemo13SceneDelegate")
...
SWIFT_CLASS("_TtC11FindingNemo14ViewController")
